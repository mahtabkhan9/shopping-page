...
const Product = ({ post }) => {
    ...
    return (
        <div className='flex flex-col items-center justify-between hover:scale-110 transition duration-300 ease-in gap-3 mt-10 ml-5 rounded-xl border-2 hover:shadow-2xl'>
            <div className=''>
